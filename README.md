...
> - Pi: install [`@automatalabs/pi-acp`](https://www.npmjs.com/package/@automatalabs/pi-acp) with `bun add -g @automatalabs/pi-acp`, then add a Pi provider instance in Settings
